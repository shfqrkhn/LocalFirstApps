...
| A3 | Normative engineering contracts | `docs/INTERCHANGE_CONTRACT.md`, `docs/PWA_ASSURANCE_CONTRACT.md`, `docs/HEALTHOS_CONTRACT.md`, `docs/LIFEOS_CONTRACT.md`, `docs/WORKOS_CONTRACT.md`, `docs/STRENGTH_CONTRACT.md`, `docs/REFLECTION_CONTRACT.md`, `docs/REPO_ZIP_POLICY.md`, and `docs/future-app-intake.md`. They govern their bounded interfaces only. |
